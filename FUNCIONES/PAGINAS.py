    ...
    if tipo_accion == acciones[0]:
        ...
        with st.form("Formulario", clear_on_submit=False):
            ...
            if io_envio:
                ...
                cursor.execute(instruccion_sql, (fecha_actualizacion,True,temperatura_laboratorio,rendimiento_columna,int(id_ref_bajo),int(id_solicitud_analisis),lote_analisis))
