        ...
        if numpy.count_nonzero(datos['io_nuevo_muestreo']) > 0:
            ...
            for idato in range(exporta_registros.shape[0]):    
                ...
                if 'latitud_muestreo' in listado_variables_datos and exporta_registros['latitud_muestreo'].iloc[idato] is not None:
                    exporta_registros['latitud_muestreo'].iloc[idato]  = float(round(exporta_registros['latitud_muestreo'].iloc[idato],4))

                if 'longitud_muestreo' in listado_variables_datos and exporta_registros['longitud_muestreo'].iloc[idato] is not None:
                    exporta_registros['longitud_muestreo'].iloc[idato]  = float(round(exporta_registros['longitud_muestreo'].iloc[idato],4))
