...
df_datos_disponibles  = pandas.merge(df_datos_biogeoquimicos, df_datos_fisicos, on="perfil")

FUNCIONES_PROCESADO.inserta_datos(df_datos_disponibles,'perfil',direccion_host,base_datos,usuario,contrasena,puerto)
