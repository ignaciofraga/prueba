...
#for iarchivo in range(1):
    ...
    datos_radprof_corregido = FUNCIONES_INSERCION.evalua_registros(datos_radprof_corregido,programa_muestreo,direccion_host,base_datos,usuario,contrasena,puerto)
